...
public class LipeRMIException extends Exception {
     ...
     * @param message
     */
    public LipeRMIException(final String message) {
        super(message);
    }
     ...
     * @param cause
     */
    public LipeRMIException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause
     */
    public LipeRMIException(final Throwable cause) {
        super(cause);
    }
}
